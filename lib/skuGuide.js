 ...
 * Returns array of { id, gtin, title, batch?, price?, bbd? }.
 */
function parseSkuGuide(csvPath) {
  ...
  for (const line of rows) {
    ...
    if (id) result.push({ id, gtin, title, batch: batch || undefined, price: price != null ? price : undefined, bbd: bbd || undefined });
  }
  return result;
}
